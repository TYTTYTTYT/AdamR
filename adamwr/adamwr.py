    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            adamw(params_with_grad,
                  ...
                  beta2=beta2,
                  lr=group['lr'],
                  weight_recovery=group['weight_recovery'],
                  eps=group['eps'],
...
def _single_tensor_adamwr(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        # Perform stepweight recovery
        param.add_(lr * weight_recovery * (recov_param - param))
...
def _multi_tensor_adamwr(params: List[Tensor],
    ...
    # Perform stepweight recovery
    delta = torch._foreach_sub(recov_params, params)
    torch._foreach_mul_(delta, lr * weight_recovery)
